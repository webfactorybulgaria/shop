...
@section('title', trans('product-categories::global.name'))

@section('main')

<div ng-app="typicms" ng-cloak ng-controller="ListController" ng-show="!initializing">

    @include('core::admin._button-create', ['module' => 'product-categories'])

    <h1>
        <span>@{{ totalModels }} @choice('product-categories::global.product-categories', 2)</span>
    </h1>
    ...
    <div class="table-responsive">
        ...
        <table st-persist="productCategoriesTable" st-table="displayedModels" st-order st-sort-default="date" st-sort-default-reverse="true" st-pipe="callServer" st-filter class="table table-condensed table-main">
            <thead>
                <tr>
            ...
            <tbody ng-class="{'table-loading':isLoading}">
                <tr ng-repeat="model in displayedModels">
                    ...
                    <td>
                        @include('core::admin._button-edit', ['module' => 'product-categories'])
                    </td>
