    ...
    <div class="row">
        <div class="col-sm-9 form-group">
            <div class="input-group">
                ...
                <input class="form-control" type="text" name="{{ $lang }}[shop_title]" value="@if(isset($preferences->$lang)){{ $preferences->$lang->shop_title }}@endif">
            </div>
        </div>
        <div class="col-sm-3 checkbox">
            <label>
                <input type="hidden" name="{{ $lang }}[shop_status]" value="0">
                <input type="checkbox" name="{{ $lang }}[shop_status]" value="1" @if(isset($preferences->$lang) and $preferences->$lang->shop_status)checked @endif> @lang('validation.attributes.online')
            </label>
        </div>
    </div>
@endforeach
